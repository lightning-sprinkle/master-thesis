...
Paywalls, however are fairly easy to circumvent. This especially accounts for soft paywalls. Therefore, publishers are trying to implement counter measures in order to enforce a subscription. For example, the \textit{New York Times} attacked one popular circumvention method, the use of an \textit{incognito window}, by detecting it an blocking it completely. %https://www.nyulawreview.org/wp-content/uploads/2018/08/NYULawReview-90-1-Troupson.pdf
