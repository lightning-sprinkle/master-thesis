...
Revenue models which are applicable on the internet in order to monetize online content is a topic that has been actively researched and experimented with over the past few decades. Even in the early days of the World Wide Web, the problem of unpaid content existed. 

This chapter is divided in into two different related work fields. Firtsly, the economic aspects of unpaid content are reviewed. Secondly, an overview of the technical solutions to the unpaid content will be given. This will include both micropayments, subscription models and online advertising.


These approaches include paywalls and web advertisements. For example, the \textit{Wall Street Journal} implemented already a hard paywall in 1996, which is still in place as of today, with over 2 million subscribers as of February 2020. 
